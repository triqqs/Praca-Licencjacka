...
if __name__ == "__main__":
    # sprawdzanie ile jest argumentów danego typu
    typ_argumentu = argumentacje_z_anotacja_df['Typ argumentu (szeregowy lub równoległy)'].value_counts()
    print(typ_argumentu)
    # print(sum([len(el) for el in result if el is not False]))
